...
- `skills/codebase-design/ARCHITECTURE-CONFORMANCE.md` is the shared plan/implementation/TDD/review rubric. Every consumer receives exact policy-accepted spec/plan identities and their binding modules, interfaces, seams/adapters, data flow, depth/locality/leverage intent, and test surface; any violation blocks completion. Under Autonomous, in-scope design corrections return through Draft and internal review to Ready; Review-gated requires new approval for the changed revision.
