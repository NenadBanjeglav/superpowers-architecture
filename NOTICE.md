...
The goal is a narrower workflow: Architecture-first Superpowers for Codex, with Design Understanding, local specs and plans, worktree-aware implementation, code commits, TDD, reviews, and phase-separated fresh sessions.
